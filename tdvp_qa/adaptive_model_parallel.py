...
from tdvp_qa.utils import annealing_energy_canonical, right_hamiltonian, left_hamiltonian, right_context_c, left_context_c, effective_hamiltonian_A, effective_hamiltonian_C


class TDVP_QA_P():
    def __init__(self, mpo0, mpo1, tensors, slope, dt, lamb=0, max_slope=0.05, min_slope=1e-6, adaptive=False, compute_states=False, key=42, slope_omega=1e-3, ds=0.01, scale_gap=False, npar=10):
        ...
        # number of parallel executions: npar=1 results in a sequential method
        self.npar = npar

        # initialize the context matrices
        self.Hright0 = right_context_c(self.mps, self.mpo0)
        self.Hright1 = right_context_c(self.mps, self.mpo1)
        self.Hleft0 = left_context_c(self.mps, self.mpo0)
        self.Hleft1 = left_context_c(self.mps, self.mpo1)
